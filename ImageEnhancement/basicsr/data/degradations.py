...
def bivarate_spatial_variant_blur(kernel_size,
                                  sigma_x,
                                  sigma_y,
                                  theta):
    if kernel_size == 1:
    ...
    h_range = np.repeat(kernel_range[None], kernel_size, axis = 0)
    v_range = np.repeat(kernel_range[:, None], kernel_size, axis = 1)
    ...
    kernel = gaussian(h_range, v_range)

    return kernel



def random_spatial_variant_blur(kernel_size,
                                sigma_x_range,
                                sigma_y_range,
                                rotation_range,
                                noise_range=None,
    ...
    kernel = bivarate_spatial_variant_blur(kernel_size=kernel_size, sigma_x=sigma_x, sigma_y=sigma_y, theta=rotation)
...
def random_mixed_kernels(kernel_list,
    ...
    elif kernel_type == 'spatial_variant':
        kernel = random_spatial_variant_blur(kernel_size, sigma_x_range, sigma_y_range, rotation_range, noise_range, isotropic=False)
    return kernel
