...
@ARCH_REGISTRY.register()
class VGGStyleDiscriminator128D3(nn.Module):
    """VGG style discriminator with input size 128 x 128.
    ...
    def __init__(self, num_in_ch, num_feat):
        super(VGGStyleDiscriminator128D3, self).__init__()
...
@ARCH_REGISTRY.register()
class VGGStyleDiscriminator256D3(nn.Module):
    """VGG style discriminator with input size 256 x 256.
    ...
    def __init__(self, num_in_ch, num_feat):
        super(VGGStyleDiscriminator256D3, self).__init__()
...
@ARCH_REGISTRY.register()
class VGGStyleDiscriminator128P3(nn.Module):
    """VGG style discriminator with input size 128 x 128.
    ...
    def __init__(self, num_in_ch, num_feat):
        super(VGGStyleDiscriminator128P3, self).__init__()
...
@ARCH_REGISTRY.register()
class VGGStyleDiscriminator256P3(nn.Module):
    """VGG style discriminator with input size 256 x 256.
    ...
    def __init__(self, num_in_ch, num_feat):
        super(VGGStyleDiscriminator256P3, self).__init__()
