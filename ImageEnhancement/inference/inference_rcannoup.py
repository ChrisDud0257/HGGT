...
from basicsr.archs.rcan_arch import RCANNOUP
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=  # noqa: E251
        '/path/to/your trained RCAN model'  # noqa: E501
    )
    ...
    # set up model
    model = RCANNOUP(num_in_ch=3,num_out_ch=3,num_feat=64,num_group=10,num_block=20,squeeze_factor=16,res_scale=1,img_range=255.,rgb_mean=(0.4488, 0.4371, 0.4040))
