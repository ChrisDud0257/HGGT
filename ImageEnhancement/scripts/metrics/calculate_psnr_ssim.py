...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='/home/chendu/data2_hdd10t/chendu/dataset/basicsr/Manga109/GTmod24',help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='/home/chendu/data2_hdd10t/chendu/myprojects/BSRGAN/results/basicsr_6benchmark/x4/Manga109', help='Path to restored images')
