...
def calculate_fid_folder():
    ...
    parser.add_argument('--folder',default='/data2_hdd10t/chendu/myprojects/BasicSR_v1344/results/EDSR_Lx2_f256b32_DIV2K/visualization/Set5', type=str, help='Path to the folder.')
    parser.add_argument('--fid_stats', default='/data2_hdd10t/chendu/myprojects/BasicSR_v1344/basicsr/metrics/niqe_pris_params.npz' ,type=str, help='Path to the dataset fid statistics.')
