...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default='/home/chendu/data2_hdd10t/chendu/myprojects/BasicSR_v1344/results/MultiGTToy2_x4_REdegra/visualization/SR/Manga109', help='Input path')
