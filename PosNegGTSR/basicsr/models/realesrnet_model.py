...
class RealESRNet_Model(SRModel):
    ...
    def __init__(self, opt):
        super(RealESRNet_Model, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(RealESRNet_Model, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
