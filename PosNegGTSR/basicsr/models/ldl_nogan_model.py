...
class LDL_noGAN_Model(SRModel):
    ...
    def __init__(self, opt):
        super(LDL_noGAN_Model, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(LDL_noGAN_Model, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
