...
- Clone this repo.
```bash
git clone https://github.com/ChrisDud0257/PosNegGT
cd PosNegGT
```
...
### Step 1: Image enhancement (*Optional*, you could just skip to step4 and train models with our proposed dataset)
...
```bash
cd PatchSelection
python patch_select.py --img_path 'Path to PosNegGTs' --save_path 'Path to your own patch selection save path'
```
...
### Step 4: Train Realistic Super-resolution models on our proposed PosNegGT
#### Installation. (Python 3 + NVIDIA GPU + CUDA. Recommend to use Anaconda)
```bash
cd PosNegGTSR
...
#### Training with a GAN with the original GT in our PosNegGT dataset or with DF2K_OST dataset.

- **Original GT in PosNegGT dataset**
...
#### Trainging with the positive GTs in our PosNegGT dataset.
...
#### Trainging with both positive and negative GTs in our PosNegGT dataset.
...
#### Testing with the model trained on the original GT in our proposed PosNegGT dataset or DF2K_OST dataset.

- **Model trained with Original GT in PosNegGT dataset**
...
- **Model trained with positive GT in our PosNegGT datset**
...
- **Model trained with both positive and negative GT in our PosNegGT datset**
